...
const Navbar = () => {
	return (
		<nav
			className="w-full h-20 bg-white text-back3 flex flex-row justify-between items-center px-5 md:px-[3%] lg:px-[8%]"
		>
			...
			<div className="flex flex-row justify-center items-center gap-7">
				<ul className="lg:flex gap-5 xl:gap-10 hidden">
					<li>
						<Link href="/">
							<span className=" text-back3 px-3 py-2 rounded cursor-pointer">Home</span>
						</Link>
					</li>
					<li>
						<Link href="/">
